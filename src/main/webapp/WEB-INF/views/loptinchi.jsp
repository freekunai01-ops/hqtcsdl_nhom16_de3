                            ...
                            <%@ include file="layout/sidebar.jsp" %>
                                <main class="content-area">
                                    <c:if test="${not empty success}">
                                        <div
                                            style="background:#d1e7dd;color:#0f5132;border:1px solid #badbcc;padding:8px 12px;border-radius:4px;margin-bottom:12px;font-size:12.5px;">
                                            <i class="fas fa-check-circle"></i> ${success}
                                        </div>
                                    </c:if>
                                    <c:if test="${not empty error}">
                                        <div
                                            style="background:#f8d7da;color:#842029;border:1px solid #f5c2c7;padding:8px 12px;border-radius:4px;margin-bottom:12px;font-size:12.5px;">
                                    ...
                                    <div class="desktop-form-window">
                                        <div class="form-window-titlebar">
                                            <div class="title-left"><i class="fas fa-chalkboard"></i> Form: Mở Lớp Tín
                                                chỉ</div>
                                            <div class="title-right"><span class="window-btn green"></span><span
                                                    class="window-btn yellow"></span><span
                                                    class="window-btn red"></span></div>
                                        </div>
                                        <div class="form-window-body">
                                            ...
                                            <%--=====Banner đơn giản, gộp 2 thành 1=====--%>
                                                <div class="ltc-notice">
                                                    ...
                                                    Cấu hình ngày <strong>Bắt đầu / Kết thúc ĐK</strong> và <strong>Hạn
                                                        hủy</strong> khi mở lớp.
                                                    Sinh viên chỉ đăng ký được trong khoảng thời gian này.
                                                    Không mở lớp cho niên khóa/học kỳ quá khứ.
                                                </div>

                                                <form id="ltcForm"
                                                    action="${pageContext.request.contextPath}/loptinchi/save"
                                                        ...
                                                        <%--=====CỘT TRÁI: Form nhập=====--%>
                                                                    ...
                                                                    <%-- Hàng 1: Mã LTC + Niên khóa --%>
                                                                        <div class="pane-row">
                                                                            <span class="pane-label"
                                                                                style="width:90px;">Mã LTC:</span>
                                                                            <div class="pane-input-wrapper">
                                                                                <input type="text" id="ltcMaltcDisplay"
                                                                                    class="pane-input" disabled
                                                                                    placeholder="(Tự động tăng)"
                                                                                    style="width:100px;">
                                                                                <input type="hidden" id="ltcMaltc"
                                                                                    name="maltc" value="">
                                                                            </div>
                                                                        </div>
                                                                        <div class="pane-row">
                                                                            <span class="pane-label"
                                                                                style="width:90px;">Niên khóa:</span>
                                                                            <div class="pane-input-wrapper">
                                                                                <input type="text" name="nienkhoa"
                                                                                    data-field="NIENKHOA"
                                                                                    class="pane-input"
                                                                                    placeholder="2025-2026"
                                                                                    maxlength="9" required <c:if
                                                                        ...
                                                                        <div class="pane-row">
                                                                            <span class="pane-label"
                                                                                style="width:90px;">Học kỳ:</span>
                                                                            <div class="pane-input-wrapper">
                                                                                <select name="hocky" data-field="HOCKY"
                                                                                    class="pane-input"
                                                                                    style="padding:4px 6px;" required
                                                                                    <c:if
                                                                                    test="${sessionScope.nhomQuyen != 'PGV'}">disabled
                                                                                    </c:if>>
                                                                        ...
                                                                        <div class="pane-row">
                                                                            <span class="pane-label"
                                                                                style="width:90px;">Nhóm:</span>
                                                                            <div class="pane-input-wrapper">
                                                                                <input type="number" name="nhom"
                                                                                    data-field="NHOM" class="pane-input"
                                                                                    min="1" value="1" required <c:if
                                                                                    test="${sessionScope.nhomQuyen != 'PGV'}">disabled
                                                                                </c:if>>
                                                                            </div>
                                                                        </div>
                                                                        <div class="pane-row">
                                                                            <span class="pane-label"
                                                                                style="width:90px;">Môn học:</span>
                                                                            <div class="pane-input-wrapper">
                                                                                <select name="mamh" data-field="MAMH"
                                                                                    class="pane-input"
                                                                                    style="padding:4px 6px;" required
                                                                                    <c:if
                                                                                    test="${sessionScope.nhomQuyen != 'PGV'}">disabled
                                                                        ...
                                                                        <div class="pane-row">
                                                                            <span class="pane-label"
                                                                                style="width:90px;">Giảng viên:</span>
                                                                            <div class="pane-input-wrapper">
                                                                                <select name="magv" data-field="MAGV"
                                                                                    class="pane-input"
                                                                                    style="padding:4px 6px;" required
                                                                                    <c:if
                                                                                    test="${sessionScope.nhomQuyen != 'PGV'}">disabled
                                                                        ...
                                                                        <div class="pane-row">
                                                                            <span class="pane-label"
                                                                                style="width:90px;">Khoa QL:</span>
                                                                            <div class="pane-input-wrapper">
                                                                                <c:choose>
                                                                                    <c:when
                                                                                        test="${sessionScope.nhomQuyen == 'PGV'}">
                                                                                        <select name="maKhoa"
                                                                                            data-field="MAKHOA"
                                                                                            class="pane-input"
                                                                        ...
                                                                        <div class="pane-row">
                                                                            <span class="pane-label"
                                                                                style="width:90px;">SV tối thiểu:</span>
                                                                            <div class="pane-input-wrapper">
                                                                                <input type="number" name="sosvtoithieu"
                                                                                    data-field="SOSVTOITHIEU"
                                                                                    class="pane-input" min="1"
                                                                                    value="20" required <c:if
                                                                                    test="${sessionScope.nhomQuyen != 'PGV'}">disabled
                                                                                </c:if>>
                                                                            </div>
                                                                        </div>
                                                            ...
                                                            <%--=====CỘT PHẢI: Danh sách gọn=====--%>
                                                                <div class="form-right-pane">
                                                                    <div class="pane-title">Danh sách lớp tín chỉ đã mở
                                                                    </div>
                                                                    <div class="table-search-box">
                                                                        <i class="fas fa-search"></i>
                                                                        <input type="text" id="ltcSearch"
                                                                            placeholder="Tìm lớp tín chỉ..."
                                                                            oninput="initTableSearch('ltcTable','ltcSearch')">
                                                                    </div>
                                                                    <div class="win-table-container">
                                                                        <table id="ltcTable" class="win-table">
                                                                            <thead>
                                                                                <tr>
                                                                                    <th data-sort-key="MALTC"
                                                                                        data-sort-col="0">Mã LTC</th>
                                                                                    <th data-sort-key="NIENKHOA"
                                                                                        data-sort-col="1">Niên khóa</th>
                                                                                    <th data-sort-key="HOCKY"
                                                                                        data-sort-col="2">HK</th>
                                                                                    <th data-sort-key="MAMH"
                                                                                        data-sort-col="3">Môn</th>
                                                                                    <th data-sort-key="NHOM"
                                                                                        data-sort-col="4">Nhóm</th>
                                                                            ...
                                                                            <tbody>
                                                                                <c:forEach items="${dsltc}" var="l">
                                                                                    <tr onclick="selectLTC(this)"
                                                                                        ...
                                                                                        <td data-col="NIENKHOA">
                                                                                            ${l.NIENKHOA}</td>
                                                                                        <td data-col="HOCKY">${l.HOCKY}
                                                                                        </td>
                                                                                        <td data-col="MAMH">${l.MAMH}
                                                                                        </td>
                                                                                        <td data-col="NHOM">${l.NHOM}
                                                                                        </td>
                                                                                        <td data-col="MAGV">${l.MAGV}
                                                                                        </td>
                                                                                        ...
                                                                                        <td data-col="HUYLOP_TXT">
                                                                                            <c:choose>
                                                                                                <c:when
                                                                                                    test="${l.HUYLOP == true}">
                                                                                                    <span
                                                                                                        class="badge-status huy"><i
                                                                                                            class="fas fa-times-circle"></i>
                                                                                                        Đã hủy</span>
                                                                                                </c:when>
                                                                                                <c:otherwise>
                                                                                                    <c:set var="nkStart"
                                                                                                        value="${fn:substring(l.NIENKHOA, 0, 4)}" />
                                                                                                    <c:choose>
                                                                                                        <c:when
                                                                                                            test="${nkStart < 2024}">
                                                                                                            <span
                                                                                                                class="badge-status lichsu"><i
                                                                                                                    class="fas fa-history"></i>
                                                                                                                Lịch
                                                                                                                sử</span>
                                                                                                        </c:when>
                                                                                                        <c:when
                                                                                                            test="${l.NIENKHOA == '2024-2025' || (l.NIENKHOA == '2025-2026' && l.HOCKY == 1)}">
                                                                                                            <span
                                                                                                                class="badge-status daxong"><i
                                                                                                                    class="fas fa-check-double"></i>
                                                                                                                Đã
                                                                                                                xong</span>
                                                                                                        </c:when>
                                                                                                        <c:when
                                                                                                            test="${l.NIENKHOA == '2026-2027'}">
                                                                                                            <span
                                                                                                                class="badge-status sapmo"><i
                                                    ...
                                                    <div class="form-buttons-row">
                                                        <c:if test="${sessionScope.nhomQuyen == 'PGV'}">
                                                            <button type="button" class="win-form-btn"
                                                                onclick="btnThemOpen()"><i class="fas fa-plus"></i>
                                                                Thêm</button>
                                                            <button type="button" class="win-form-btn btn-delete"
                                                        ...
                                                        <button type="button" class="win-form-btn"
                                                            onclick="btnThoat('${pageContext.request.contextPath}/home')"><i
                                                                class="fas fa-sign-out-alt"></i> Thoát</button>
                                                    </div>
                                                </form>
                                        </div>
                                        <div class="form-window-status">
                                            ...
                                            <span>
                                                <c:choose>
                                                    <c:when test="${sessionScope.maKhoa == 'ALL'}">Khoa: Tất cả</c:when>
                                                    <c:otherwise>Khoa: ${sessionScope.maKhoa}</c:otherwise>
                                                </c:choose>
                                            </span>
                                        </div>
                                    </div>
