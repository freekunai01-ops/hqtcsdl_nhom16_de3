...
CREATE TABLE LOPTINCHI (
    ...
    CONSTRAINT CHK_LOPTINCHI_HOCKY CHECK (HOCKY BETWEEN 1 AND 3),
    CONSTRAINT CHK_LOPTINCHI_NHOM CHECK (NHOM >= 1),
    CONSTRAINT CHK_LOPTINCHI_SOSVTOITHIEU CHECK (SOSVTOITHIEU > 0),
    CONSTRAINT CHK_LOPTINCHI_SOSVTOIDA CHECK (SOSVTOIDA >= SOSVTOITHIEU)
);
GO
...
CREATE TABLE DANGKY (
    ...
    CONSTRAINT CHK_DANGKY_DIEM_CC CHECK (DIEM_CC IS NULL OR (DIEM_CC >= 0 AND DIEM_CC <= 10)),
    CONSTRAINT CHK_DANGKY_DIEM_GK CHECK (DIEM_GK IS NULL OR (DIEM_GK >= 0 AND DIEM_GK <= 10)),
