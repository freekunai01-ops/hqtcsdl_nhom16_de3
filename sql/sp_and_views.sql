...
BEGIN
    ...
    BEGIN RAISERROR(N'Nhóm lớp tín chỉ này đã tồn tại!',16,1); RETURN; END
...
BEGIN
    ...
    SET NIENKHOA=@NIENKHOA,HOCKY=@HOCKY,MAMH=@MAMH,NHOM=@NHOM,
        MAGV=@MAGV,SOSVTOITHIEU=@SOSVTOITHIEU,HUYLOP=@HUYLOP
    WHERE MALTC=@MALTC;
END
GO
